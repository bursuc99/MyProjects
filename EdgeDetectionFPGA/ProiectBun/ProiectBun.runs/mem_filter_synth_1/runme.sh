...
HD_PWD='D:/SSC-LAB/ProiectBun/ProiectBun.runs/mem_filter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_filter.tcl
